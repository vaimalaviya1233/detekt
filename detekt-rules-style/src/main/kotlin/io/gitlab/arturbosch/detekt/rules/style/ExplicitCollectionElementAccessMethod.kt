...
class ExplicitCollectionElementAccessMethod(config: Config = Config.empty) : Rule(config, "Prefer usage of the indexed access operator [] for map element access or insert methods.") {
