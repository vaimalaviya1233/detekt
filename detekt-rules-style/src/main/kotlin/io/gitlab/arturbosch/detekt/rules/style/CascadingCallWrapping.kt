 ...
 * </compliant>
 */
class CascadingCallWrapping(config: Config = Config.empty) : Rule(config, "If a chained call is wrapped to a new line, subsequent chained calls should be as well.") {
