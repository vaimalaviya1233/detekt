...
class UseArrayLiteralsInAnnotations(config: Config = Config.empty) : Rule(config, "Array literals [...] should be preferred as they are more readable than `arrayOf(...)` expressions.") {
