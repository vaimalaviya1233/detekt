...
class FunctionOnlyReturningConstant(config: Config = Config.empty) : Rule(config, "A function that only returns a constant is misleading. Consider declaring a constant instead.") {
