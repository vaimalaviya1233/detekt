...
class UnusedPrivateProperty(config: Config = Config.empty) : Rule(config, "Property is unused and should be removed.") {    override val defaultRuleIdAliases: Set<String> =
