...
class UnusedParameter(config: Config = Config.empty) : Rule(config, "Function parameter is unused and should be removed.") {    override val defaultRuleIdAliases: Set<String> =
