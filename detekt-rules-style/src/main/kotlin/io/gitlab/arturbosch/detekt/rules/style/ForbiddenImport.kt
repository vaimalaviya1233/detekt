 ...
 * </noncompliant>
 */
class ForbiddenImport(config: Config = Config.empty) : Rule(config, "Mark forbidden imports. A forbidden import could be an import for an unstable / experimental api " +
