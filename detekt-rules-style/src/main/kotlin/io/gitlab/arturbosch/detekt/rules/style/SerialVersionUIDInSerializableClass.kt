...
class SerialVersionUIDInSerializableClass(config: Config = Config.empty) : Rule(config, "A class which implements the Serializable interface does not define a correct serialVersionUID field. " +
