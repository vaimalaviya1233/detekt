...
class UtilityClassWithPublicConstructor(config: Config = Config.empty) : Rule(config, "The class declaration is unnecessary because it only contains utility functions. " +
