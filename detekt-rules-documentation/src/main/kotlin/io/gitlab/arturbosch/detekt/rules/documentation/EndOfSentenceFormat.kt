...
class EndOfSentenceFormat(config: Config = Config.empty) : Rule(config, "The first sentence in a KDoc comment should end with proper punctuation or with a correct URL.") {
