...
class BooleanPropertyNaming(config: Config = Config.empty) : Rule(config, "Boolean property name should follow the naming convention set in the projects configuration.") {
