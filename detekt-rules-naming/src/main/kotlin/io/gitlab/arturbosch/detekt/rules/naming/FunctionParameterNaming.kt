...
class FunctionParameterNaming(config: Config = Config.empty) : Rule(config, "Function parameter names should follow the naming convention set in the projects configuration.") {
