 ...
 */
class LambdaParameterNaming(config: Config = Config.empty) : Rule(config, "Lambda parameter names should follow the naming convention set in the projects configuration.") {
