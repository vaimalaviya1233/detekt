...
class TopLevelPropertyNaming(config: Config = Config.empty) : Rule(config, "Top level property names should follow the naming convention set in the projects configuration.") {
