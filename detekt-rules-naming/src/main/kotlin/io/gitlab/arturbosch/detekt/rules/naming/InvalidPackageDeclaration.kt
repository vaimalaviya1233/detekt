...
class InvalidPackageDeclaration(config: Config = Config.empty) : Rule(config, "Kotlin source files should be stored in the directory corresponding to its package statement.") {
