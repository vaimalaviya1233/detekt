 ...
 */
class FunctionNameMaxLength(config: Config = Config.empty) : Rule(config, "Function names should not be longer than the maximum set in the project configuration.") {
