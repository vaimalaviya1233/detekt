 ...
 * </noncompliant>
 */
class NotImplementedDeclaration(config: Config = Config.empty) : Rule(config, "The NotImplementedDeclaration should only be used when a method stub is necessary. " +
