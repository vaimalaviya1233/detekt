...
class ObjectExtendsThrowable(config: Config = Config.empty) : Rule(config, "An `object` should not extend and type of Throwable. Throwables are stateful and should be instantiated " +
