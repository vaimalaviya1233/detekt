...
class ThrowingNewInstanceOfSameException(config: Config = Config.empty) : Rule(config, "Avoid catch blocks that rethrow a caught exception wrapped inside a new instance of the same exception.") {
