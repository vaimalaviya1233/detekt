...
class ExceptionRaisedInUnexpectedLocation(config: Config = Config.empty) : Rule(config, "This method is not expected to throw exceptions. This can cause weird behavior.") {
