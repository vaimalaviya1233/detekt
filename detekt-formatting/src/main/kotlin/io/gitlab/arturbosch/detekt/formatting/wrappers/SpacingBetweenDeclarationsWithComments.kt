...
class SpacingBetweenDeclarationsWithComments(config: Config) : FormattingRule(config, "Declarations and declarations with comments should have an empty space between.") {
