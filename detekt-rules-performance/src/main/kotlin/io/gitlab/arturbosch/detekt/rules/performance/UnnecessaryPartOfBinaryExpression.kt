 ...
 *
 */
class UnnecessaryPartOfBinaryExpression(config: Config = Config.empty) : Rule(config, "Detects duplicate condition into binary expression and recommends to remove unnecessary checks") {
