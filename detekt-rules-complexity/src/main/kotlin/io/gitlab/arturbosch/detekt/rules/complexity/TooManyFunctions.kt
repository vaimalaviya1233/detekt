...
class TooManyFunctions(config: Config = Config.empty) : Rule(config, "Too many functions inside a/an file/class/object/interface always indicate a violation of " +
