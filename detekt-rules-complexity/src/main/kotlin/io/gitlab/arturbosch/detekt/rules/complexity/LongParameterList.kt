...
class LongParameterList(config: Config = Config.empty) : Rule(config, "The more parameters a function has the more complex it is. Long parameter lists are often " +
