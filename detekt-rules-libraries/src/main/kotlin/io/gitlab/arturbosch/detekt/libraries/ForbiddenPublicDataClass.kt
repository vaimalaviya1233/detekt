...
class ForbiddenPublicDataClass(config: Config = Config.empty) : Rule(config, "The data classes are bad for the binary compatibility in public APIs. Avoid to use it.") {
