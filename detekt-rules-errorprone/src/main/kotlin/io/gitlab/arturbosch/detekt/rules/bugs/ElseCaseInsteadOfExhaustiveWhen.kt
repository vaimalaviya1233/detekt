...
class ElseCaseInsteadOfExhaustiveWhen(config: Config = Config.empty) : Rule(config, "A `when` expression that has an exhaustive set of cases should not contain an `else` case.") {
    @Configuration(
