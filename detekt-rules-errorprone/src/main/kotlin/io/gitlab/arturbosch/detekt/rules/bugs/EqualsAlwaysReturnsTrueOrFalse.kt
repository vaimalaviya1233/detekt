...
class EqualsAlwaysReturnsTrueOrFalse(config: Config = Config.empty) : Rule(config, "Having an `equals()` method that always returns true or false is not a good idea. " +
