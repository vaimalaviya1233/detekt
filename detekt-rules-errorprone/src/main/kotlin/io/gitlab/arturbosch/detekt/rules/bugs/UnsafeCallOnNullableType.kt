...
class UnsafeCallOnNullableType(config: Config = Config.empty) : Rule(config, "Unsafe calls on nullable types detected. These calls will throw a NullPointerException in case " +
