...
class IteratorHasNextCallsNextMethod(config: Config = Config.empty) : Rule(config, "The `hasNext()` method of an Iterator implementation should not call the `next()` method. " +
